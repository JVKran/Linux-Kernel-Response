...
int main(int argc, char *argv[])
{
  ...
  curl_easy_setopt(hnd, CURLOPT_URL, "https://thingsboard.jvkran.com/api/v1/Response-Client/telemetry");
  curl_easy_setopt(hnd, CURLOPT_NOPROGRESS, 1L);
  curl_easy_setopt(hnd, CURLOPT_POSTFIELDS, "{response_time: 163}");
